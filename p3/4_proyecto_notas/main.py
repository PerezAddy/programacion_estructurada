...
def main():
    ...
    while opcion:
        ...
        if opcion=="1" or opcion=="REGISTRO":
            ...
            password=("\t Ingresa tu contraseña: ").strip()
            #Agregar codigo
            registro=usuario.registrar_usuario(nombre, apellidos, email, password)
            if registro:
                print(f"{nombre}{apellidos} se registro correctamente con el email {email}")
            else:
                print("Error al registrar el usuario, intenta de nuevo.")
            ...
            if lista_usuario:
                ...
                print("E-mail y/o contraseña incorrectos, intenta de nuevo.")
                funciones.esperarTecla()
